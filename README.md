...
the reasons for descisions made are in the technical notes file. No infringements intended.

How to Run:

To play a game, download and unzip the codebase and open the command line interface (cmd on windows).
Navigate to the folder and run the run.py file.
